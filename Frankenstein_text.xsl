...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!-- processes the marginal additions again to give them a class to hide them in the 'main' text in css. By hiding them using css, they can also be made visible again when showing a reading text, for example-->
    ...
    <!-- transform the tei:lb in <br/> empty elements -->
    <xsl:template match="tei:lb">
        <br/>
    </xsl:template>
    
    <!-- tei:hi[@rend = 'indented'] to later on style in CSS -->
    ...
    <!-- tei:hi[@rend = 'sup'] in superscript element -->
    ...
    <!-- tei underlined text to underlined element --> 
    ...
    <!-- tei overwritten to html element -->
    ...
    <!-- tei crossedout to html element -->
